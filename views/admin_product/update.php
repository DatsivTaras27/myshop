        ...
        <div class="row">
            ...
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Редагування товарур</li>
                </ol>
            </div>
            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <input type="file" name="image" placeholder="" value="<?php echo isset($product['image']) ? $product['image'] : ''; ?>">
                        ...
                        <select name="status">
                            ...
                            <option value="0" <?php if ($product['status'] == 0) echo ' selected="selected"'; ?>>Не відображати</option>
                        </select>

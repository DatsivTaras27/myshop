                            ...
                            <div class="col-sm-6">
                                <div class="contactinfo">
                                    <ul class="nav nav-pills">
                                        <li><a href="#"><i class="fa fa-phone"></i> +38 097 291 78 21</a></li>
                                        <li><a href="#"><i class="fa fa-envelope"></i> datsivTaras@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="logo pull-left">
                                    <h2 style="margin:0px;"><a href="/"><span style="color:#FE980F;">Taras</span><span style="color:#696763;">Shop</span></a></h2>
                                </div>
                            </div>
                            <div class="col-sm-8">
